  ...
  return (
    <div className="bg-gray-100 min-h-screen flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-lg  w-full">
        ...
        <div className="mt-6">
          <h2 className="text-xl font-semibold text-gray-700 border-b border-red-600">資格</h2>
          <p className="text-gray-600 mt-2">
            ITパスポート, TOEIC R＆L (530点)
          </p>
        </div>
        ...
        <div className="mt-6">
          <h2 className="text-xl font-semibold text-gray-700 border-b border-red-600">趣味</h2>
          <p className="text-gray-600 mt-2">
            プログラミング, ウォーキング, 読書, 麻雀, 
          </p>
        </div>
